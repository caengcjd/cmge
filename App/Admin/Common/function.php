 ...
 * @author huajie <banhuajie@163.com>
 */
function get_osflag_url($osflag_url = null){
    if(!isset($osflag_url)){
        return false;
    }
    switch ($osflag_url){
        case 'pc'  : return    'PC预约';     break;
        case 'wap'  : return    'WAP预约';     break;
        default : return    false;      break;
    }
}
/**
 ...
 * @author huajie <banhuajie@163.com>
 */
function get_osflag($osflag = null){
    if(!isset($osflag)){
        return false;
    }
    switch ($osflag){
        case '1'  : return    'iOS正版';     break;
        case '2'  : return    'android';     break;
		case '3'  : return    'iOS越狱';     break;
        default : return    false;      break;
    }
}
